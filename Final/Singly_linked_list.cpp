...
int Repeated_node_count()
{
    ...
    while(curr1->Next !=NULL)
    {
        ...
        {
            if(curr1->info == curr2->info && outer<inner)
            {
                count++;
                break;
            }
   ...
   bool is_ascending()
   {
    ...
    void insertion_sort(int value)
    {
        ...
        if(is_ascending())
        {
            ...
            Nodes *curr=head;
            Nodes *prev=curr;
            while(curr->info<value && curr->Next!=NULL)
            {
                prev=curr;
                curr=curr->Next;
            }
...
int main(void)
{
    ...
    L1.display_linked_list();
    L1.insertion_sort(22);
    L1.display_linked_list();
    L1.insertion_sort(1);
    L1.display_linked_list();

    cout<<"Number of nodes repeated itself:"<<L1.Repeated_node_count();

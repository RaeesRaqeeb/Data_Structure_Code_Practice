...
void reversing()
    ...
    void remove_duplicate()
    {
        ...
        while(curr->Next !=NULL)
        {
            ...
            {
                Nodes *temp1=curr->Next;
                Nodes *temp2=curr->Next;
                while(curr->info==temp2->info)
                    { 
                    if(temp2->Next!=NULL)
                        temp2=temp2->Next;
                    else 
...
int main(void)
{
    ...
    DL1.Doubly_display();
    //  cout<<"Number of nodes in the double linkedlist is:"<<DL1.counting_node(DL1.head,0)+1<<endl;

    DL1.reversing();
    // cout<<"Display"<<endl;
     DL1.Doubly_display();
     DL1.remove_duplicate();
     DL1.Doubly_display();
